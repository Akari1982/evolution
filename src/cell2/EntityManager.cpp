...
void
EntityManager::DebugOnthogenesisAddCell( const int x, const int y )
{
    //m_Ontogenesis->AddCell( x, y );
}



void
EntityManager::DebugOnthogenesisAddProtein( const int id, const float radius, const int x, const int y )
{
    //m_Ontogenesis->AddProtein( id, radius, x, y );
}
